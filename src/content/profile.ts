...
export const profile: Profile = {
    ...
    },
    {
      ...
      highlights: {
        ru: [
          ...
          "Наставлял двух мидл-инженеров и сократил их онбординг на две недели.",
          "07.2023 — 12.2024, внутренний проект по зрелости разработки: комплексно разобрал около 30 проектов компании с командами и британскими заказчиками по собственному фреймворку оценки, чтобы понять, где процесс проваливается и что чинить в первую очередь. Оценка удовлетворённости проектом выросла на 20%, около 70% рекомендаций команды закрывали в течение квартала.",
        ...
        pl: [
          ...
          "Mentorował dwóch inżynierów mid i skrócił ich onboarding o dwa tygodnie.",
          "07.2023 — 12.2024, wewnętrzny program dojrzałości inżynierskiej: kompleksowo przejrzał około 30 projektów firmy z zespołami i brytyjskimi klientami według własnego frameworku oceny, żeby zobaczyć, gdzie proces się sypie i co naprawić najpierw. Ocena zadowolenia z projektu wzrosła o 20%, zespoły zamykały około 70% rekomendacji w ciągu kwartału.",
  ...
  education: {
    ru: [
      "Белорусский государственный университет, Минск — бакалавр математики и математической кибернетики, 2016–2020. Изучал проектирование алгоритмов, моделирование данных, статистический анализ и вычислительные системы.",
    ],
    en: [
      "Belarusian State University, Minsk — B.Sc. in Mathematics and Mathematical Cybernetics, 2016–2020. Studied algorithm design, data modelling, statistical analysis and computational systems.",
    ],
    pl: [
      "Białoruski Uniwersytet Państwowy, Mińsk — licencjat z matematyki i cybernetyki matematycznej, 2016–2020. Studiował projektowanie algorytmów, modelowanie danych, analizę statystyczną i systemy obliczeniowe.",
    ],
  },
  ...
  gaps: {
    ru: [
      ...
      "Nest.js: руками работал, но в основном на некоммерческих проектах. Сервис на Nest.js в продакшене не вёл.",
    ],
    en: [
